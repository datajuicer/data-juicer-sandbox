...
from data_juicer_sandbox.evaluators import BaseEvaluator
from data_juicer_sandbox.model_executors import BaseModelExecutor
...
class EasyAnimateTrainExecutor(BaseModelExecutor):
    ...
    5. other items can be referred to <config_dir>/easyanimate_text_to_video/model_train.yaml.
    """
    ...
    def __init__(self, model_config: dict, watcher=None):
        ...
        self.env.install_py_deps(["deepspeed", "func_timeout", "wandb<=0.19.0"])
